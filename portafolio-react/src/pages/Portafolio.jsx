  ...
  return (
    ...
    >
      <div className="wrap">
        ...
        {categoria.subtitulo && (
          <Reveal delay={0.05} as="p" className={styles.secSubtitulo}>{categoria.subtitulo}</Reveal>
        )}
      ...
      <section className={styles.introSection}>
        <div className="wrap">
          <Reveal className={styles.textBlock}>
            <p>Este portafolio reúne el trabajo que desarrollé durante mis prácticas profesionales en el Comité de Cafeteros del Valle del Cauca, específicamente en el área de Comunicaciones. Llegué a una institución con más de 95 años de historia, con un territorio extenso, públicos muy diversos y un reto comunicacional concreto: acercar una organización gremial sólida, pero compleja, a las personas que la sostienen todos los días desde sus fincas.</p>
            <p>Lo que encontré no fue solo una entidad con redes sociales, sino una historia que merecía contarse mejor. Así que desde el primer día empecé a construir, probar y ajustar: guiones para reels, flyers de campaña electoral, coberturas institucionales, piezas emotivas para fechas especiales y contenidos que, sin perder el rigor institucional, hablaran de verdad con los caficultores del Valle del Cauca.</p>
            <p>Lo que aquí se presenta no es el plan con el que llegué, sino lo que aprendí al caminar. Cada pieza tiene detrás una decisión estratégica, una lectura del contexto y una intención clara: que comunicar también es construir gremio.</p>
          </Reveal>
        </div>
      </section>
      ...
      <main>
        <section className={styles.portSection} id="estrategia">
          <div className="wrap">
            ...
            <Reveal delay={0.16} className={styles.voteSection}>
              <p className={styles.voteEyebrow}>Estrategia electoral 2026</p>
              <h3 className={styles.voteTitle}>Tu voto, tu gremio</h3>
              <p className={styles.voteTagline}>Facebook informa. Instagram activa.</p>
              <div className={styles.voteGoal}>
                <span className={styles.voteGoalLabel}>Objetivo central</span>
                <span className={styles.voteGoalText}>Convertir alcance en voto — 40+ deciden, jóvenes movilizan</span>
              </div>

              <div className={styles.platformGrid}>
                <div className={`${styles.platformCard} ${styles.platformFb}`}>
                  <div className={styles.platformHead}>
                    <span className={styles.platformName}>Facebook</span>
                    <span className={styles.platformFollowers}>9.900<small>seguidores</small></span>
                  </div>
                  <dl className={styles.platformList}>
                    <div><dt>Rol estratégico</dt><dd>Informar y mantener la confianza</dd></div>
                    <div><dt>Audiencia core</dt><dd>Caficultores 40+ · votantes</dd></div>
                    <div><dt>Consumo</dt><dd>Lento · denso · informativo</dd></div>
                    <div><dt>Formatos top</dt><dd>Carruseles · historias · imágenes</dd></div>
                    <div><dt>Mejor tema</dt><dd>Elecciones · Federación · datos técnicos</dd></div>
                  </dl>
                  <p className={styles.platformMetric}>Métrica: alcance + retención · Interacción actual: pasiva</p>
                </div>

                <div className={`${styles.platformCard} ${styles.platformIg}`}>
                  <div className={styles.platformHead}>
                    <span className={styles.platformName}>Instagram</span>
                    <span className={styles.platformFollowers}>7.555<small>seguidores</small></span>
                  </div>
                  <dl className={styles.platformList}>
                    <div><dt>Rol estratégico</dt><dd>Informar y activar a los jóvenes</dd></div>
                    <div><dt>Audiencia core</dt><dd>40+ y jóvenes del sector</dd></div>
                    <div><dt>Consumo</dt><dd>Rápido · scroll · visual</dd></div>
                    <div><dt>Formatos top</dt><dd>Reels · tendencias · híbridos visuales</dd></div>
                    <div><dt>Mejor tema</dt><dd>Testimonios · campo · animaciones IA</dd></div>
                  </dl>
                  <p className={styles.platformMetric}>Métrica: alcance + retención · Meta: activar jóvenes</p>
                </div>
              </div>

              <h4 className={styles.voteSubhead}>Tres públicos, tres funciones</h4>
              <div className={styles.publicosGrid}>
                <div className={styles.publicoCard}>
                  <p className={styles.publicoNombre}>Caficultores 40+</p>
                  <p className={styles.publicoDesc}>Votantes core · Facebook</p>
                  <p className={styles.publicoPref}>Prefieren: información clara y técnica</p>
                  <span className={`${styles.publicoTag} ${styles.tagVotar}`}>Función: votar</span>
                </div>
                <div className={styles.publicoCard}>
                  <p className={styles.publicoNombre}>Jóvenes del sector</p>
                  <p className={styles.publicoDesc}>Extensionistas y empleados · Instagram</p>
                  <p className={styles.publicoPref}>Prefieren: reels, tendencias y dinamismo</p>
                  <span className={`${styles.publicoTag} ${styles.tagMovilizar}`}>Función: movilizar</span>
                </div>
                <div className={styles.publicoCard}>
                  <p className={styles.publicoNombre}>Amantes del café</p>
                  <p className={styles.publicoDesc}>Público urbano secundario · ambas</p>
                  <p className={styles.publicoPref}>Prefieren: historias reales e información clara</p>
                  <span className={`${styles.publicoTag} ${styles.tagInteresar}`}>Función: interesar</span>
                </div>
              </div>

              <div className={styles.clavesBar}>
                <span className={styles.clavesLabel}>Claves de ejecución</span>
      ...
      <section className={styles.contactSection} id="contacto">
        <div className="wrap">
          <Reveal className={styles.contactInner}>
            <p className={styles.secLabel}>Hablemos</p>
            <h2 className={styles.secTitle}>Contacto</h2>
            <div className={styles.secRule} />
            <ul className={styles.contactList}>
              <li>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4z" /><path d="m22 6-10 7L2 6" /></svg>
                <a href="mailto:pelaezvalverdetania@gmail.com">pelaezvalverdetania@gmail.com</a>
              </li>
              <li>
                ...
                <a href="tel:+573172273409">+57 317 227 3409</a>
              </li>
              <li>
                ...
                <a href="https://instagram.com/tania_0224" target="_blank" rel="noopener noreferrer">@tania_0224</a>
              </li>
              <li>
